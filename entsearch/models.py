...
class User:
    ...
    def __init__(self, email: str, username: str, password: str, created: Optional[str] = None) -> None:
...
class Dataset:
    ...
    def __repr__(self) -> str:
        return (f"Dataset(id={self.id}, title='{self.title}', user_id={self.user_id}, "
                f"created='{self.created}')")
...
class Entity:
    ...
    def __init__(self, dataset_id: int, entity_name: str, entity_name_embed: Any, description: str, foreign_identifier: str) -> None:
        self.id: int = self._generate_id()
    ...
    def __repr__(self) -> str:
        return (f"Entity(id={self.id}, dataset_id={self.dataset_id}, "
