...
def dataset_detail(dataset_password):
    ...
    return render_template('dataset_detail.html', dataset=dataset, entities=entities, user_id=user_id)
...
def current_dataset(password):
    ...
    print("@@@:", last_elements)
    return render_template('edit_dataset_page.html', dataset=last_elements, dataset_password=password, user_id=user_id)