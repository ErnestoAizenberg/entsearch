    ...
    try:
        for i, row in df.iterrows():
            try:
                ...
                return (
                    None,
                    f"error: не удалось извлечь данные из строки {i} - {str(e)}",
                )
            ...
            try:
                ...
                return (
                    None,
                    f"error: не удалось создать сущность на строке {i} - {str(e)}",
                )

            try:
                last_id = entity_repo.insert_entity(entity)
                if last_id is None:
                    None, f"error: не удалось вставить сущность на строке {i}"

            except Exception as e:
                return (
                    None,
                    f"error: не удалось вставить сущность на строке {i} - {str(e)}",
                )
