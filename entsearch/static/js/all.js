...
function getValueFromUrl() {
    ...
    const currentIndex  = currentUrl.indexOf('current');
    return currentIndex !== -1 ? currentUrl[currentIndex + 1] : "Не найдено";
}

function updateFormValue() {
    document.getElementById('currentValue').value = getValueFromUrl();
}
