...
function getValueFromUrl(){const a=window.location.href.split('/'),b=a.indexOf('current');return b!==-1?a[b+1]:"Не найдено"}function updateFormValue(){document.getElementById('currentValue').value=getValueFromUrl()}document.addEventListener('DOMContentLoaded',updateFormValue);